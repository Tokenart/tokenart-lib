export default function NoLicenseIcon({color, props}) {
    ...
    return (
        `<svg ${props} width="77" height="77" viewBox="0 0 77 77" fill="${bgColor}" xmlns="http://www.w3.org/2000/svg">
            <path stroke="${strokeColor}" d="M38.5 75.3202C58.8352 75.3202 75.3201 58.8353 75.3201 38.5001C75.3201 18.1649 58.8352 1.67993 38.5 1.67993C18.1648 1.67993 1.67987 18.1649 1.67987 38.5001C1.67987 58.8353 18.1648 75.3202 38.5 75.3202Z"/>
